-- อาซ้อฟ่างKGHUB Roll/Buy v6.9.4 Drop Guide + Color Tags + Server Resume
...
log("START | version=ui-v6.9.4-drop-guide | pool="..#charCatalog.." | mutations="..#mutCatalog.." | rules="..#RT.rules.." | delay="..delayNow().." | config="..CONFIG_FILE.." | rulesFile="..RULES_FILE.." | traderCatalog="..TRADER_CATALOG)
refresh("Drop Guide + Responsive UI | F5 Trader | F6 Roll | F7 Auto Buy")
print("[อาซ้อฟ่างKGHUB ui-v6.9.4-drop-guide] loaded | pool="..#charCatalog.." mutations="..#mutCatalog.." log="..LOG)
end
startRuntime()
