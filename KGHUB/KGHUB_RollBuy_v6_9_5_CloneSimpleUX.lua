-- อาซ้อฟ่างKGHUB Roll/Buy v6.9.5 Clone Simple UX + Drop Guide + Color Tags + Server Resume
...
local refreshTabs
local tabButtons={}
local tabOrder={"ROLL","RULES","TRADER","INFO","EVENT","CLONE","DROP","CONFIG"}
local tabLabels={ROLL="⚡  สุ่ม / ซื้อ",RULES="◆  กฎการซื้อ",TRADER="◈  ร้านค้า",INFO="◉  ข้อมูลตัวละคร",EVENT="✦  อีเวนต์ / ยา",CLONE="♊  Auto Clone",DROP="▣  DROP GUIDE",CONFIG="⚙  ตั้งค่า"}
...
local tabGroups={ROLL=rollGroup,RULES=rulesGroup,TRADER=traderGroup,INFO=infoGroup,EVENT=eventGroup,CLONE=RT.cloneUI.group or {},DROP=RT.dropUI.group or {},CONFIG=configGroup}
...
log("START | version=ui-v6.9.5-clone-simple-ux | pool="..#charCatalog.." | mutations="..#mutCatalog.." | rules="..#RT.rules.." | delay="..delayNow().." | config="..CONFIG_FILE.." | rulesFile="..RULES_FILE.." | traderCatalog="..TRADER_CATALOG)
refresh("Drop Guide + Responsive UI | F5 Trader | F6 Roll | F7 Auto Buy")
print("[อาซ้อฟ่างKGHUB ui-v6.9.5-clone-simple-ux] loaded | pool="..#charCatalog.." mutations="..#mutCatalog.." log="..LOG)
end
startRuntime()
